...
public class OrientationManager extends ReactContextBaseJavaModule {
    ...
    private static final String NAME = "OrientationManager";
    private static final String ORIENTATION_UPDATE_EVENT = "OrientationUpdate";
    ...
    private SensorEventListener mSensorListener = new SensorEventListener() {
        ...
        private void sendOrientationUpdate() {
            ...
            params.putDouble("heading", mHeading);
            params.putDouble("pitch", mPitch);

            sendEvent(getReactApplicationContext(), ORIENTATION_UPDATE_EVENT, params);
        }
    ...
    private LocationListener mLocationListener = new LocationListener() {
        private void sendLocationUpdate() {
            WritableMap params = Arguments.createMap();
            params.putDouble("lat", mLocation.getLatitude());
            params.putDouble("lon", mLocation.getLongitude());

            sendEvent(getReactApplicationContext(), LOCATION_UPDATE_EVENT, params);
        }
    ...
    public OrientationManager(ReactApplicationContext reactContext) {
        ...
        mUpdateInterval = DEFAULT_INTERVAL;
            ...
            mRunnable = new Runnable() {
                ...
                public void run() {
                    if (mTracking) {
                        ...
                        mHandler.postDelayed(mRunnable, mUpdateInterval);
                    }
                }
            };
            mHandler.postDelayed(mRunnable, mUpdateInterval);
